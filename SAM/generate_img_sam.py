...
def parse_option():
    ...
    parser.add_argument('-i', '--image_dir', default="../data/img/rayleigh/0.33_4QAM_2.6/label")
    parser.add_argument('-f', '--sam_img_dir', default="../data/img/rayleigh/0.33_4QAM_2.6/seg")
