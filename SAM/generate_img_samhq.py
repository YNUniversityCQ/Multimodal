...
def parse_option():
    ...
    parser.add_argument('-i','--image_dir', default="../data/img/rayleigh/0.3_16QAM_4.3/label")
    parser.add_argument('-f','--sam_img_dir', default="../data/img/rayleigh/0.3_16QAM_4.3/seghq" )
